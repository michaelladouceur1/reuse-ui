import React, { useEffect, useState, useCallback, useMemo, CSSProperties, memo } from "react";
...
import { ISelectionArea, ISelectionItem } from "@/types";
...
function SelectionArea(props: ISelectionArea) {
	...
	const selectionName = (selection: ISelectionItem) => {
	...
	const handleSelection = (selection: ISelectionItem) => {
	...
	const selectionElements = useMemo(() => {
		return props.selections.map((selection: ISelectionItem, idx: number) => {
			return (
